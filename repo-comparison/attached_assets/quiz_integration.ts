...
class NutritionRecommender {
   ...
   * @param {Recommendation} recommendation - Données de la recommandation
   * @return {HTMLElement} - Élément de carte de recommandation
   */
  private createRecommendationCard(recommendation: Recommendation): HTMLElement {
...
// Pour TypeScript avec modules ES6, utilisez:
// export { NutritionRecommender };

// Pour la compatibilité avec le code existant:
(window as any).nutritionRecommender = nutritionRecommender;

...
const Sitemap = () => {
  ...
  const siteStructure = [
    ...
    },
    {
      ...
      links: [
        { name: t('Our Research'), path: '/our-research' },
        { name: t('Scientific Publications'), path: '/scientific-library' },
        { name: t('Scientific Methodology'), path: '/scientific-methodology' },
        { name: t('Lab Solutions'), path: '/lab-solutions' },
      ]
    },
    {
      ...
      links: [
        ...
        { name: t('Health Profile'), path: '/health-profile' },
